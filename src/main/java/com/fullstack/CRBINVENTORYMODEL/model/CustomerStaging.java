...
public class CustomerStaging {
    ...
    public CustomerStaging(String source, String dateOfItem, String ecooCompanyName, String isin, String cuspin, String sedol, String privateComapanyName, String nonPermisibleExpectedDate, String status, Date date) {
        this.source = source;
