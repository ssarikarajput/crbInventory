...
public class CustomerAudit {
    ...
    public CustomerAudit(String source, String dateOfItem, String ECOOCompanyName, String isin, String cuspin, String sedol, String privateComapanyName, String nonPermisibleExpectedDate, String status, Date date) {
        this.source = source;
